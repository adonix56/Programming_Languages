...
public class Scan {
    ...
    public Scan(String args[]) { // the constructor
        ...
        try {
            ...
            System.out.println("Exception opening file "+args[0]+"\n");
    ...
    public Token scan() {
        if( got_eof ) {
            System.out.println("scan: oops -- called after eof.");
...
// QUESTION 3:  What does the following case and the code in it do?
    ...
    private Token ccase2(char c1, char c2, TK r) {
        ...
        if (c == c2) {
            ...
            System.out.println("scan: got " + c1 +
                               " missing " + c2 +
                               " (got ASCII " + c + ")");
    ...
    private String buildID() {
        ...
        if( myisalpha((char) c) && k == MAXLEN_ID ) {
            ...
            System.out.println("scan: identifier too long -- truncated to "
                               + str);
        }
        return str;
    }
    ...
    private String buildNUM() {
        ...
        if( myisdigit((char) c) && k == MAXLEN_ID ) {
            ...
            System.out.println("scan: number too long -- truncated to "
                               + str);
        }
        return str;
    }
